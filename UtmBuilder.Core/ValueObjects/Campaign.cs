...
public class Campaign : ValueObject
{
        ...
        string? content = null)
    {
        ...
        InvalidCampignException.ThrowIfNull(source, "Source is invalid");
        InvalidCampignException.ThrowIfNull(medium, "Medium is invalid");
        InvalidCampignException.ThrowIfNull(name, "Name is invalid");
    }
